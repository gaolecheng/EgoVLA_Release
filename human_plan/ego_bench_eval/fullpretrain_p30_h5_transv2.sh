...
PUSHBOX_GUIDANCE_ENABLE=${41}
PUSHBOX_STUCK_WINDOW=${42}
PUSHBOX_STUCK_BOX_MOVE_THRESH=${43}
...
PUSHBOX_GUIDANCE_ENABLE_ARG=""
if [ -n "$PUSHBOX_GUIDANCE_ENABLE" ]; then
  PUSHBOX_GUIDANCE_ENABLE_ARG="--pushbox_guidance_enable $PUSHBOX_GUIDANCE_ENABLE"
fi
PUSHBOX_STUCK_WINDOW_ARG=""
if [ -n "$PUSHBOX_STUCK_WINDOW" ]; then
  PUSHBOX_STUCK_WINDOW_ARG="--pushbox_stuck_window $PUSHBOX_STUCK_WINDOW"
fi
PUSHBOX_STUCK_BOX_MOVE_THRESH_ARG=""
if [ -n "$PUSHBOX_STUCK_BOX_MOVE_THRESH" ]; then
  PUSHBOX_STUCK_BOX_MOVE_THRESH_ARG="--pushbox_stuck_box_move_thresh $PUSHBOX_STUCK_BOX_MOVE_THRESH"
fi
